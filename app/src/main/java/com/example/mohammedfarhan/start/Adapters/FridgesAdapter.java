...
public class FridgesAdapter extends RecyclerView.Adapter<FridgesAdapter.ViewHolder> {


    Context mcontext;
    ArrayList<Fridges> mFridges;
    public FridgesAdapter(Context context, ArrayList<Fridges> Fridges){
...
//           });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fridges_layout, parent, false);
