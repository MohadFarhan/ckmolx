...
public class FurnituresListAdapter extends RecyclerView.Adapter<FurnituresListAdapter.ViewHolder> {


    Context mcontext;
    ArrayList<Furnitures> mFurnitures;
    public FurnituresListAdapter(Context context, ArrayList<Furnitures> Furnitures){
...
//           });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.furniture_list_layout, parent, false);
