...
public class WashingMachineListAdapter extends RecyclerView.Adapter<WashingMachineListAdapter.ViewHolder> {


    Context mcontext;
    ArrayList<WashingMachine> mWashingMachine;
    public WashingMachineListAdapter(Context context, ArrayList<WashingMachine> WashingMachine){
...
//           });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.washingmachine_list_layout, parent, false);
