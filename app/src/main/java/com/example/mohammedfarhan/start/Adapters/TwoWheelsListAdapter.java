...
public class TwoWheelsListAdapter extends RecyclerView.Adapter<TwoWheelsListAdapter.ViewHolder> {


    Context mcontext;
    ArrayList<TwoWheel> mTwoWheel;
    public TwoWheelsListAdapter(Context context, ArrayList<TwoWheel> TwoWheel){
...
//           });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.two_wheel_list_layout, parent, false);
