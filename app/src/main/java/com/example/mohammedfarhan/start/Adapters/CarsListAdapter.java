...
public class CarsListAdapter extends RecyclerView.Adapter<CarsListAdapter.ViewHolder> {
    ...
    public CarsListAdapter(Context context, ArrayList<Cars> Cars){
...
//           });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cars_list_layout, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Picasso.with(mcontext).load(cars.getCarImageUrl()).placeholder(mcontext.getResources()
                .getDrawable(R.drawable.white)).error(mcontext.getResources().getDrawable(R.drawable.white)).into(holder.mobileIV);
