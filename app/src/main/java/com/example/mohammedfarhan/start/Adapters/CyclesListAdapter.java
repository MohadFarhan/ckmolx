...
public class CyclesListAdapter extends RecyclerView.Adapter<CyclesListAdapter.ViewHolder> {


    Context mcontext;
    ArrayList<Cycles> mCycles;
    public CyclesListAdapter(Context context, ArrayList<Cycles> Cycles){
...
//           });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cycles_list_layout, parent, false);
